		...
		initLayer: function () {
			...
			var all_html = [
				'<header style="height: ' + headerHeightCss + '; line-height: ' + headerHeightCss + '" class="iosselect-header">',
					...
					'<a style="height: ' + headerHeightCss + '; line-height: ' + headerHeightCss + '" href="javascript:void(0)" class="_sure">' + sureText + '</a>',
				...
				'</div>',
				'<div  style="height:40px;color:#00508d;font-size:18px; " class="flexCenter bgw sure ">确 定</div>'
			].join('\r\n');
